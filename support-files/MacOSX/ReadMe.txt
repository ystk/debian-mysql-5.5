...
2.4.2 Installing MySQL on OS X Using Native Packages
   ...
   the installer file mysql-5.5.59-osx10.9-x86_64.dmg installs
   MySQL into /usr/local/mysql-5.5.59-osx10.9-x86_64/ . The
   ...
   created during installation will be created automatically.
    ...
    2. Double-click the MySQL installer package. It will be
       ...
       server 5.5.59, double-click
       mysql-5.5.59-osx-10.9-x86_64.pkg.
    ...
    5. From the Installation Type page you can either click
       ...
       Figure 2.26 MySQL Package Installer: Destination Select
...
2.4.4 Installing and Using the MySQL Preference Pane
   ...
   To install the MySQL Preference Pane:
    ...
    3. Click Customize at the Installation Type step. The
       ...
       default.
       Figure 2.33 MySQL Installer on OS X: Customize
   ...
   Figure 2.34 MySQL Preference Pane: Location
   MySQL Preference Pane: Location
