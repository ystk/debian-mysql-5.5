...
2.4.2 Installing MySQL on OS X Using Native Packages
   ...
   the installer file mysql-5.5.50-osx10.9-x86_64.dmg installs
   MySQL into /usr/local/mysql-5.5.50-osx10.9-x86_64/ . The
   ...
   created during installation will be created automatically.
    ...
    2. Double-click the MySQL installer package. It will be
       ...
       server 5.5.50, double-click
       mysql-5.5.50-osx-10.9-x86_64.pkg.
